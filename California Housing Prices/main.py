...
def get_default_model(modeltype):
	...
	if modeltype == "linear"       : reg_model = LinearRegression()
	if modeltype == "decisiontree" : reg_model = DecisionTreeRegressor()
	if modeltype == "randomforest" : reg_model = RandomForestRegressor()
...
def process_training_model():
	...
	trainer = mytrain.GridSearchModel("random_grid_1",get_default_model("randomforest"),param_grid,train_prepared, train_label)
